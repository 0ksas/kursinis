...
\section{Generatyviniai adversariniai tinklai}
    \subsection{GAN modelis}
        Pirmasis generatyvinis adversarinis tinklas buvo pristatytas 2014 metais Montrealio universiteto mokslininkų\cite{OrigGan}. Jo principas sudarytas iš dviejų dalių. Pirmoji dalis yra generatyvinis modelis $G$, kuris pasisavina nuotraukų domeno požymius ir pagal juos sugeba kurti nuotraukas. Antroji – diskriminacinis modelis $D$, kurio tikslas yra gavus nuotrauką nuspėti tikimybę ar nuotrauka yra iš mokomo domeno, ar yra sugeneruota modelio $G$. Šiuo metodu, generatyvinis modelis $G$ yra pastoviai mokomas geriau kurti nuotraukas, kurios apgautų diskriminacinį modelį $D$, o diskriminacinis modelis $D$ yra pastoviai mokomas geriau atpažinti sugeneruotą nuotrauką nuo tikros.
...
\section{Eksperimentas}
    \subsection{Duomenų rinkiniai}
        ...
        \subsection{Mokymo platformos} %Išdėstyt, per kur mokau
        ...
        \subsection{Mokymo procesas} %kokie modeliai, kiek laiko truko, einamieji pavyzdžiai 
...
\sectionnonum{Rezultatai ir išvados}
    ...
    \subsection*{Gauti FID įverčiai}
        \begin{table}[H]
            \footnotesize
            \centering
            \caption{Apmokytų modelių gauti FID įverčiai ir atrasti automobilių kiekiai.}
            {\begin{tabular}{|l|c|c|} \hline
