...
\section{Metodologija}
    \subsection{Duomenų rinkiniai}
        ...
        \subsection{Mokymo procesas} %kokie modeliai, kiek laiko truko, einamieji pavyzdžiai 
            ...
            \begin{figure}[H]
                \centering
                \[ lr = 2\times10^{-4} \times \frac{ max(0, ep - ep_n)}{ep_d + 1} \]
                \captionsetup{width=.6\linewidth}
                \caption{Epchos mokymo greičio skaičiavimo formulė (čia $ep$ - einamoji epocha, 
...
%mašinų procentai nuotraukose tokių rezultatų paaiškinimui
%dienos nakties problemos
%FID
%gamtos geras gavimasis
%trinami kapotai
%asfalto ir dangaus spalvos
