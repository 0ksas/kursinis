...
\sectionnonum{Rezultatai ir išvados}
    ...
    \subsection*{FID įverčiai ir automobilių atpažintų automobilių kiekiai}
        Modelių sąrašas nuo geriausio iki blogiausio vertinant pagal FID:
        \begin{enumerate}
            \item MSPC V2
            \item CycleGAN V2
            \item MSPC V1
        ...
        Modelių sąrašas nuo geriausio iki blogiausio vertinant pagal transformuotose nuotraukose atpažintų automobilių kiekius:
        \begin{enumerate}
            \item MSPC V2
            \item CycleGAN V1
            \item CycleGAN V2
